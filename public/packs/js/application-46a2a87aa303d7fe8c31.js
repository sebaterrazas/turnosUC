...
var map = {
	...
	"./hovercard_controller.js": "./app/javascript/controllers/hovercard_controller.js"
};
  ...
  _createClass(_default, [{
    ...
    value: function show() {
      ...
      if (this.hasCardTarget) {
        ...
        fetch(this.urlValue).then(function (r) {
          return r.text();
        }).then(function (html) {
...
var application = !(function webpackMissingModule() { var e = new Error("Cannot find module 'stimulus'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).start(document.documentElement);
...
/******/ });
//# sourceMappingURL=application-46a2a87aa303d7fe8c31.js.map