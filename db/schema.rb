...
ActiveRecord::Schema.define(version: 2022_06_12_222948) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["turno_id"], name: "index_messages_on_turno_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.bigint "turno_id", null: false
    t.index ["turno_id"], name: "index_reviews_on_turno_id"
  ...
  add_foreign_key "messages", "turnos"
  add_foreign_key "messages", "users"
  add_foreign_key "requests", "turnos"
  add_foreign_key "requests", "users"
  add_foreign_key "reviews", "turnos"
