...
class Cliente:
    ...
    def thread_escuchar(self):
        while True:
            try:
                longitud_bytes_de_respuesta = self.socket_cliente.recv(4)
                ...
                while len(respuesta) < longitud_respuesta:
                    ...
                    respuesta.extend(self.socket_cliente.recv(leer_longitud))

                self.manejar_comando({'comando': respuesta})
            except ConnectionError:
    ...
    def enviar(self, msg):
        ...
        self.socket_cliente.sendall(longitud_bytes_mensaje + mensaje_codificado)
